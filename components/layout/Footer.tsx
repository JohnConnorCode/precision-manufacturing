        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/careers" className="text-slate-400 hover:text-blue-600 transition-colors">
                  Careers
                </Link>
              </li>
              <li>
                <Link href="/industries" className="text-slate-400 hover:text-blue-600 transition-colors">
                  Industries
                </Link>
              </li>
              <li>
                <Link href="/compliance/terms" className="text-slate-400 hover:text-blue-600 transition-colors">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link href="/compliance/supplier-requirements" className="text-slate-400 hover:text-blue-600 transition-colors">
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start space-x-2">
                ...
                <a href="mailto:officemgr@iismet.com" className="text-slate-400 hover:text-blue-600 transition-colors">
                  officemgr@iismet.com
                </a>
              </li>
              <li className="flex items-start space-x-2">
                <Phone className="h-4 w-4 text-slate-400 mt-0.5" />
                <a href="tel:+15032319093" className="text-slate-400 hover:text-blue-600 transition-colors">
                  +1 (503) 231-9093
                </a>
              </li>
              <li className="flex items-start space-x-2">
