...
export function CTAButton({ href, children, variant = 'primary' }: CTAButtonProps) {
  ...
  const variantClasses = {
    primary: "bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-600 text-white shadow-xl shadow-blue-600/25 hover:shadow-2xl hover:shadow-blue-600/40 hover:-translate-y-0.5",
