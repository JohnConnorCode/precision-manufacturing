...
import { ArrowRight, Cpu, TrendingUp, Shield, CheckCircle, Activity, Brain } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <HeroSection
        ...
        title={
          <>
            <span className="text-white">Adaptive</span> <span className="bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent">Machining</span>
          </>
        }
