      ...
      <div className="container relative z-10 py-24 max-w-6xl">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
            <a href="mailto:legal@iismet.com" className="flex items-center gap-3 text-white hover:text-slate-300 transition-colors">
              <Mail className="w-5 h-5" />
              <span>legal@iismet.com</span>
            </a>
            <span className="hidden md:block text-slate-600">•</span>
            <a href="tel:+15032319093" className="flex items-center gap-3 text-white hover:text-slate-300 transition-colors">
