      ...
      <section className="relative overflow-hidden border-b-2 border-accent-cyan/20">
        ...
        <div className="container relative py-24">
          ...
          >
            ...
            >
              <span className="inline-flex items-center px-4 py-1.5 rounded-full text-xs font-bold bg-gradient-to-r from-accent-cyan/20 to-accent-electric/20 text-accent-cyan border border-accent-cyan/30">
            ...
            >
              Comprehensive standards ensuring excellence in aerospace and precision manufacturing supply chain
            </motion.p>
        ...
        >
                  ...
                  <div className="flex items-start gap-4">
                    {req.icon && (
                      <div className="w-10 h-10 rounded-lg bg-accent-cyan/10 flex items-center justify-center flex-shrink-0 mt-1">
                        <req.icon className="w-5 h-5 text-accent-cyan" />
                      </div>
                    )}
          ...
          <div className="space-y-6">
            {additionalSections.map((section, index) => (
              <motion.div
                key={section.number}
                variants={itemVariants}
                custom={requirements.length + index}
              >
          ...
          >
            <div className="flex items-center gap-4 mb-4">
              ...
              <h3 className="text-2xl font-bold">Compliance Commitment</h3>
            </div>
            <p className="text-muted-foreground leading-relaxed">
              By accepting purchase orders from Integrated Inspection Systems, Inc., suppliers acknowledge
              and agree to comply with all requirements stated in this document. Continuous improvement
              and commitment to quality excellence are fundamental expectations of our supply chain partners.
            </p>
          </motion.div>
        </motion.div>
      </section>
